...
<span data-ttu-id="d55a2-109">線路處理常式是使用 DI 註冊的。</span><span class="sxs-lookup"><span data-stu-id="d55a2-109">Circuit handlers are registered using DI.</span></span> <span data-ttu-id="d55a2-110">系統會為每個線路的實例建立範圍實例。</span><span class="sxs-lookup"><span data-stu-id="d55a2-110">Scoped instances are created per instance of a circuit.</span></span> <span data-ttu-id="d55a2-111">使用 `TrackingCircuitHandler` 上述範例中的，會建立單一服務，因為必須追蹤所有線路的狀態：</span><span class="sxs-lookup"><span data-stu-id="d55a2-111">Using the `TrackingCircuitHandler` in the preceding example, a singleton service is created because the state of all circuits must be tracked:</span></span>
...
## <a name="manual-rendertreebuilder-logic"></a><span data-ttu-id="d55a2-117">手動 RenderTreeBuilder 邏輯</span><span class="sxs-lookup"><span data-stu-id="d55a2-117">Manual RenderTreeBuilder logic</span></span>

<span data-ttu-id="d55a2-118"><xref:Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder> 提供操作元件和元素的方法，包括以 c # 程式碼手動建立元件。</span><span class="sxs-lookup"><span data-stu-id="d55a2-118"><xref:Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder> provides methods for manipulating components and elements, including building components manually in C# code.</span></span>

> [!NOTE]
> <span data-ttu-id="d55a2-119">使用 <xref:Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder> 來建立元件是一個 advanced 案例。</span><span class="sxs-lookup"><span data-stu-id="d55a2-119">Use of <xref:Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder> to create components is an advanced scenario.</span></span> <span data-ttu-id="d55a2-120">格式不正確的元件 (例如，未封閉的標記標記) 可能會導致未定義的行為。</span><span class="sxs-lookup"><span data-stu-id="d55a2-120">A malformed component (for example, an unclosed markup tag) can result in undefined behavior.</span></span>

<span data-ttu-id="d55a2-121">請考慮下列 `PetDetails` 元件，它可以手動內建在另一個元件中：</span><span class="sxs-lookup"><span data-stu-id="d55a2-121">Consider the following `PetDetails` component, which can be manually built into another component:</span></span>
...
<span data-ttu-id="d55a2-139">上述程式碼會編譯成如下所示的內容：</span><span class="sxs-lookup"><span data-stu-id="d55a2-139">The preceding code compiles to something like the following:</span></span>
...
<span data-ttu-id="d55a2-140">第一次執行程式碼時，產生器 `someFlag` 會 `true` 收到：</span><span class="sxs-lookup"><span data-stu-id="d55a2-140">When the code executes for the first time, if `someFlag` is `true`, the builder receives:</span></span>

| <span data-ttu-id="d55a2-141">順序</span><span class="sxs-lookup"><span data-stu-id="d55a2-141">Sequence</span></span> | <span data-ttu-id="d55a2-142">類型</span><span class="sxs-lookup"><span data-stu-id="d55a2-142">Type</span></span>      | <span data-ttu-id="d55a2-143">資料</span><span class="sxs-lookup"><span data-stu-id="d55a2-143">Data</span></span>   |
| :------: | --------- | :----: |
| <span data-ttu-id="d55a2-144">0</span><span class="sxs-lookup"><span data-stu-id="d55a2-144">0</span></span>        | <span data-ttu-id="d55a2-145">Text node</span><span class="sxs-lookup"><span data-stu-id="d55a2-145">Text node</span></span> | <span data-ttu-id="d55a2-146">First</span><span class="sxs-lookup"><span data-stu-id="d55a2-146">First</span></span>  |
| <span data-ttu-id="d55a2-147">1</span><span class="sxs-lookup"><span data-stu-id="d55a2-147">1</span></span>        | <span data-ttu-id="d55a2-148">Text node</span><span class="sxs-lookup"><span data-stu-id="d55a2-148">Text node</span></span> | <span data-ttu-id="d55a2-149">Second</span><span class="sxs-lookup"><span data-stu-id="d55a2-149">Second</span></span> |

<span data-ttu-id="d55a2-150">想像這 `someFlag` 會變成 `false` ，然後再次轉譯標記。</span><span class="sxs-lookup"><span data-stu-id="d55a2-150">Imagine that `someFlag` becomes `false`, and the markup is rendered again.</span></span> <span data-ttu-id="d55a2-151">這次，產生器會收到：</span><span class="sxs-lookup"><span data-stu-id="d55a2-151">This time, the builder receives:</span></span>

| <span data-ttu-id="d55a2-152">順序</span><span class="sxs-lookup"><span data-stu-id="d55a2-152">Sequence</span></span> | <span data-ttu-id="d55a2-153">類型</span><span class="sxs-lookup"><span data-stu-id="d55a2-153">Type</span></span>       | <span data-ttu-id="d55a2-154">資料</span><span class="sxs-lookup"><span data-stu-id="d55a2-154">Data</span></span>   |
| :------: | ---------- | :----: |
| <span data-ttu-id="d55a2-155">1</span><span class="sxs-lookup"><span data-stu-id="d55a2-155">1</span></span>        | <span data-ttu-id="d55a2-156">Text node</span><span class="sxs-lookup"><span data-stu-id="d55a2-156">Text node</span></span>  | <span data-ttu-id="d55a2-157">Second</span><span class="sxs-lookup"><span data-stu-id="d55a2-157">Second</span></span> |

<span data-ttu-id="d55a2-158">當執行時間執行差異時，會看到順序中的專案 `0` 已移除，因此它會產生下列簡單的 *編輯腳本* ：</span><span class="sxs-lookup"><span data-stu-id="d55a2-158">When the runtime performs a diff, it sees that the item at sequence `0` was removed, so it generates the following trivial *edit script* :</span></span>

* <span data-ttu-id="d55a2-159">移除第一個文位元組點。</span><span class="sxs-lookup"><span data-stu-id="d55a2-159">Remove the first text node.</span></span>

### <a name="the-problem-with-generating-sequence-numbers-programmatically"></a><span data-ttu-id="d55a2-160">以程式設計方式產生序號的問題</span><span class="sxs-lookup"><span data-stu-id="d55a2-160">The problem with generating sequence numbers programmatically</span></span>

<span data-ttu-id="d55a2-161">想像一下，您應該改為撰寫下列轉譯樹產生器邏輯：</span><span class="sxs-lookup"><span data-stu-id="d55a2-161">Imagine instead that you wrote the following render tree builder logic:</span></span>
...
<span data-ttu-id="d55a2-162">現在，第一個輸出是：</span><span class="sxs-lookup"><span data-stu-id="d55a2-162">Now, the first output is:</span></span>

| <span data-ttu-id="d55a2-163">順序</span><span class="sxs-lookup"><span data-stu-id="d55a2-163">Sequence</span></span> | <span data-ttu-id="d55a2-164">類型</span><span class="sxs-lookup"><span data-stu-id="d55a2-164">Type</span></span>      | <span data-ttu-id="d55a2-165">資料</span><span class="sxs-lookup"><span data-stu-id="d55a2-165">Data</span></span>   |
| :------: | --------- | :----: |
| <span data-ttu-id="d55a2-166">0</span><span class="sxs-lookup"><span data-stu-id="d55a2-166">0</span></span>        | <span data-ttu-id="d55a2-167">Text node</span><span class="sxs-lookup"><span data-stu-id="d55a2-167">Text node</span></span> | <span data-ttu-id="d55a2-168">First</span><span class="sxs-lookup"><span data-stu-id="d55a2-168">First</span></span>  |
| <span data-ttu-id="d55a2-169">1</span><span class="sxs-lookup"><span data-stu-id="d55a2-169">1</span></span>        | <span data-ttu-id="d55a2-170">Text node</span><span class="sxs-lookup"><span data-stu-id="d55a2-170">Text node</span></span> | <span data-ttu-id="d55a2-171">Second</span><span class="sxs-lookup"><span data-stu-id="d55a2-171">Second</span></span> |

<span data-ttu-id="d55a2-172">此結果與先前的案例相同，因此不會有負面問題。</span><span class="sxs-lookup"><span data-stu-id="d55a2-172">This outcome is identical to the prior case, so no negative issues exist.</span></span> <span data-ttu-id="d55a2-173">`someFlag` 是 `false` 在第二個轉譯上，輸出為：</span><span class="sxs-lookup"><span data-stu-id="d55a2-173">`someFlag` is `false` on the second rendering, and the output is:</span></span>

| <span data-ttu-id="d55a2-174">順序</span><span class="sxs-lookup"><span data-stu-id="d55a2-174">Sequence</span></span> | <span data-ttu-id="d55a2-175">類型</span><span class="sxs-lookup"><span data-stu-id="d55a2-175">Type</span></span>      | <span data-ttu-id="d55a2-176">資料</span><span class="sxs-lookup"><span data-stu-id="d55a2-176">Data</span></span>   |
| :------: | --------- | ------ |
| <span data-ttu-id="d55a2-177">0</span><span class="sxs-lookup"><span data-stu-id="d55a2-177">0</span></span>        | <span data-ttu-id="d55a2-178">Text node</span><span class="sxs-lookup"><span data-stu-id="d55a2-178">Text node</span></span> | <span data-ttu-id="d55a2-179">Second</span><span class="sxs-lookup"><span data-stu-id="d55a2-179">Second</span></span> |

<span data-ttu-id="d55a2-180">這次，diff 演算法會看到發生 *兩* 項變更，而演算法會產生下列編輯腳本：</span><span class="sxs-lookup"><span data-stu-id="d55a2-180">This time, the diff algorithm sees that *two* changes have occurred, and the algorithm generates the following edit script:</span></span>

* <span data-ttu-id="d55a2-181">將第一個文位元組點的值變更為 `Second` 。</span><span class="sxs-lookup"><span data-stu-id="d55a2-181">Change the value of the first text node to `Second`.</span></span>
* <span data-ttu-id="d55a2-182">移除第二個文位元組點。</span><span class="sxs-lookup"><span data-stu-id="d55a2-182">Remove the second text node.</span></span>

<span data-ttu-id="d55a2-183">產生序號已遺失有關 `if/else` 原始程式碼中的分支和迴圈出現位置的所有實用資訊。</span><span class="sxs-lookup"><span data-stu-id="d55a2-183">Generating the sequence numbers has lost all the useful information about where the `if/else` branches and loops were present in the original code.</span></span> <span data-ttu-id="d55a2-184">這會導致差異 **兩次（只要** 前面）。</span><span class="sxs-lookup"><span data-stu-id="d55a2-184">This results in a diff **twice as long** as before.</span></span>

<span data-ttu-id="d55a2-185">這是一個簡單的範例。</span><span class="sxs-lookup"><span data-stu-id="d55a2-185">This is a trivial example.</span></span> <span data-ttu-id="d55a2-186">在更實際的案例中，如果是複雜且深層的嵌套結構，特別是迴圈，則效能成本通常較高。</span><span class="sxs-lookup"><span data-stu-id="d55a2-186">In more realistic cases with complex and deeply nested structures, and especially with loops, the performance cost is usually higher.</span></span> <span data-ttu-id="d55a2-187">差異演算法必須在轉譯樹狀結構中進行深度遞迴，而不是立即識別已插入或移除的迴圈區塊或分支。</span><span class="sxs-lookup"><span data-stu-id="d55a2-187">Instead of immediately identifying which loop blocks or branches have been inserted or removed, the diff algorithm has to recurse deeply into the render trees.</span></span> <span data-ttu-id="d55a2-188">這通常是因為 diff 演算法 misinformed 了舊的和新的結構彼此之間的關聯性，而導致必須建立較長的編輯腳本。</span><span class="sxs-lookup"><span data-stu-id="d55a2-188">This usually results in having to build longer edit scripts because the diff algorithm is misinformed about how the old and new structures relate to each other.</span></span>

### <a name="guidance-and-conclusions"></a><span data-ttu-id="d55a2-189">指引和結論</span><span class="sxs-lookup"><span data-stu-id="d55a2-189">Guidance and conclusions</span></span>

* <span data-ttu-id="d55a2-190">如果序號是動態產生的，應用程式效能就會受到影響。</span><span class="sxs-lookup"><span data-stu-id="d55a2-190">App performance suffers if sequence numbers are generated dynamically.</span></span>
