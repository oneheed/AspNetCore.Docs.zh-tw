# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="6d9d2-101">Blazor WebAssembly 範例應用程式</span><span class="sxs-lookup"><span data-stu-id="6d9d2-101">Blazor WebAssembly Sample App</span></span>
