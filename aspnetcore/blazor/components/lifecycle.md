...
---
# <a name="aspnet-core-no-locblazor-lifecycle"></a><span data-ttu-id="e6e09-103">ASP.NET Core :::no-loc(Blazor)::: 生命週期</span><span class="sxs-lookup"><span data-stu-id="e6e09-103">ASP.NET Core :::no-loc(Blazor)::: lifecycle</span></span>
...
<span data-ttu-id="e6e09-202">在 `FetchData` 範本的元件中 :::no-loc(Blazor)::: ， <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> 會覆寫以 asychronously 接收預測資料 (`forecasts`) 。</span><span class="sxs-lookup"><span data-stu-id="e6e09-202">In the `FetchData` component of the :::no-loc(Blazor)::: templates, <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> is overridden to asychronously receive forecast data (`forecasts`).</span></span> <span data-ttu-id="e6e09-203">當 `forecasts` 為時 `null` ，就會向使用者顯示載入訊息。</span><span class="sxs-lookup"><span data-stu-id="e6e09-203">When `forecasts` is `null`, a loading message is displayed to the user.</span></span> <span data-ttu-id="e6e09-204">在 `Task` 傳回之後 <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> ，元件會以更新狀態保存。</span><span class="sxs-lookup"><span data-stu-id="e6e09-204">After the `Task` returned by <xref:Microsoft.AspNetCore.Components.ComponentBase.OnInitializedAsync%2A> completes, the component is rerendered with the updated state.</span></span>

<span data-ttu-id="e6e09-205">`Pages/FetchData.razor` 在 :::no-loc(Blazor Server)::: 範本中：</span><span class="sxs-lookup"><span data-stu-id="e6e09-205">`Pages/FetchData.razor` in the :::no-loc(Blazor Server)::: template:</span></span>
...
<span data-ttu-id="e6e09-215">若要避免應用程式中的雙呈現案例 :::no-loc(Blazor Server)::: ：</span><span class="sxs-lookup"><span data-stu-id="e6e09-215">To avoid the double-rendering scenario in a :::no-loc(Blazor Server)::: app:</span></span>
...
<span data-ttu-id="e6e09-219">下列程式碼示範 `WeatherForecastService` 以範本為基礎的應用程式中已更新 :::no-loc(Blazor Server)::: ，可避免雙重轉譯：</span><span class="sxs-lookup"><span data-stu-id="e6e09-219">The following code demonstrates an updated `WeatherForecastService` in a template-based :::no-loc(Blazor Server)::: app that avoids the double rendering:</span></span>
