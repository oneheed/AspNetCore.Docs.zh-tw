...
<span data-ttu-id="bcf83-113">本文中的指導方針適用于 :::no-loc(Blazor WebAssembly)::: 下列主題中所述的 AAD 部署案例：</span><span class="sxs-lookup"><span data-stu-id="bcf83-113">The guidance in this article applies to the :::no-loc(Blazor WebAssembly)::: AAD deployment scenarios described in the following topics:</span></span>
...
<span data-ttu-id="bcf83-126">下列範例假設使用者已指派給 AAD *計費管理員* 角色。</span><span class="sxs-lookup"><span data-stu-id="bcf83-126">The following examples assume that a user is assigned to the AAD *Billing Administrator* role.</span></span>
...
* [<span data-ttu-id="bcf83-137">使用 Graph SDK</span><span class="sxs-lookup"><span data-stu-id="bcf83-137">Use the Graph SDK</span></span>](#use-the-graph-sdk)
...
<span data-ttu-id="bcf83-146">上述程式碼不包含可轉移的成員資格。</span><span class="sxs-lookup"><span data-stu-id="bcf83-146">The preceding code doesn't include transitive memberships.</span></span> <span data-ttu-id="bcf83-147">如果應用程式需要直接且可轉移的群組成員資格宣告：</span><span class="sxs-lookup"><span data-stu-id="bcf83-147">If the app requires direct and transitive group membership claims:</span></span>
...
<span data-ttu-id="bcf83-154">`GraphAPIAuthorizationMessageHandler.cs`:</span><span class="sxs-lookup"><span data-stu-id="bcf83-154">`GraphAPIAuthorizationMessageHandler.cs`:</span></span>
...
<span data-ttu-id="bcf83-174">在中為每個群組或角色建立 [原則](xref:security/authorization/policies) `Program.Main` 。</span><span class="sxs-lookup"><span data-stu-id="bcf83-174">Create a [policy](xref:security/authorization/policies) for each group or role in `Program.Main`.</span></span> <span data-ttu-id="bcf83-175">下列範例會建立 AAD *計費管理員* 角色的原則：</span><span class="sxs-lookup"><span data-stu-id="bcf83-175">The following example creates a policy for the AAD *Billing Administrator* role:</span></span>
...
<span data-ttu-id="bcf83-180">如果使用者未登入，系統會將他們重新導向至 AAD 登入頁面，然後在登入之後返回該元件。</span><span class="sxs-lookup"><span data-stu-id="bcf83-180">If the user isn't logged in, they're redirected to the AAD sign-in page and then back to the component after they sign in.</span></span>
...
### <a name="app-settings"></a><span data-ttu-id="bcf83-202">應用程式設定</span><span class="sxs-lookup"><span data-stu-id="bcf83-202">App settings</span></span>
...
### <a name="controller-access"></a><span data-ttu-id="bcf83-217">控制器存取</span><span class="sxs-lookup"><span data-stu-id="bcf83-217">Controller access</span></span>
...
<span data-ttu-id="bcf83-227">設定時 <xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents> ：</span><span class="sxs-lookup"><span data-stu-id="bcf83-227">When configuring <xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents>:</span></span>
...
<span data-ttu-id="bcf83-234">在上述程式碼中，處理下列權杖錯誤是選擇性的：</span><span class="sxs-lookup"><span data-stu-id="bcf83-234">In the preceding code, handling the following token errors is optional:</span></span>
...
* <span data-ttu-id="bcf83-264">針對程式程式碼：</span><span class="sxs-lookup"><span data-stu-id="bcf83-264">For the code line:</span></span>
...
<span data-ttu-id="bcf83-272">AAD 註冊的應用程式也可以設定為使用使用者定義的角色。</span><span class="sxs-lookup"><span data-stu-id="bcf83-272">An AAD-registered app can also be configured to use user-defined roles.</span></span>
...
<span data-ttu-id="bcf83-284">元件授權方法此時可正常運作。</span><span class="sxs-lookup"><span data-stu-id="bcf83-284">Component authorization approaches are functional at this point.</span></span> <span data-ttu-id="bcf83-285">元件中的任何授權機制都可以使用 `admin` 角色來授權使用者：</span><span class="sxs-lookup"><span data-stu-id="bcf83-285">Any of the authorization mechanisms in components can use the `admin` role to authorize the user:</span></span>
...
<span data-ttu-id="bcf83-348">Intune 管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-348">Intune administrator</span></span> | <span data-ttu-id="bcf83-349">79950741-23fa-4189-b2cb-46640601c497</span><span class="sxs-lookup"><span data-stu-id="bcf83-349">79950741-23fa-4189-b2cb-46640601c497</span></span>
<span data-ttu-id="bcf83-350">Kaizala 管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-350">Kaizala administrator</span></span> | <span data-ttu-id="bcf83-351">d6322af2-48e7-42e0-8c68-0bbe31af3412</span><span class="sxs-lookup"><span data-stu-id="bcf83-351">d6322af2-48e7-42e0-8c68-0bbe31af3412</span></span>
<span data-ttu-id="bcf83-352">授權管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-352">License administrator</span></span> | <span data-ttu-id="bcf83-353">3355458a-e423-44bf-8b98-4ac5e572cea5</span><span class="sxs-lookup"><span data-stu-id="bcf83-353">3355458a-e423-44bf-8b98-4ac5e572cea5</span></span>
<span data-ttu-id="bcf83-354">訊息中心隱私權讀取者</span><span class="sxs-lookup"><span data-stu-id="bcf83-354">Message center privacy reader</span></span> | <span data-ttu-id="bcf83-355">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span><span class="sxs-lookup"><span data-stu-id="bcf83-355">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span></span>
<span data-ttu-id="bcf83-356">訊息中心讀取者</span><span class="sxs-lookup"><span data-stu-id="bcf83-356">Message center reader</span></span> | <span data-ttu-id="bcf83-357">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span><span class="sxs-lookup"><span data-stu-id="bcf83-357">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span></span>
<span data-ttu-id="bcf83-358">Office 應用程式管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-358">Office apps administrator</span></span> | <span data-ttu-id="bcf83-359">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span><span class="sxs-lookup"><span data-stu-id="bcf83-359">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span></span>
<span data-ttu-id="bcf83-360">密碼管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-360">Password administrator</span></span> | <span data-ttu-id="bcf83-361">466e48b7-5d66-4ae5-8911-1a118de74941</span><span class="sxs-lookup"><span data-stu-id="bcf83-361">466e48b7-5d66-4ae5-8911-1a118de74941</span></span>
<span data-ttu-id="bcf83-362">Power BI 管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-362">Power BI administrator</span></span> | <span data-ttu-id="bcf83-363">984e83b8-8337-4255-91a1-acb663175ab4</span><span class="sxs-lookup"><span data-stu-id="bcf83-363">984e83b8-8337-4255-91a1-acb663175ab4</span></span>
<span data-ttu-id="bcf83-364">Power Platform 管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-364">Power platform administrator</span></span> | <span data-ttu-id="bcf83-365">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span><span class="sxs-lookup"><span data-stu-id="bcf83-365">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span></span>
<span data-ttu-id="bcf83-366">特殊權限驗證管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-366">Privileged authentication administrator</span></span> | <span data-ttu-id="bcf83-367">0829f731-b46d-419f-9742-aeb122367d11</span><span class="sxs-lookup"><span data-stu-id="bcf83-367">0829f731-b46d-419f-9742-aeb122367d11</span></span>
<span data-ttu-id="bcf83-368">特殊權限角色管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-368">Privileged role administrator</span></span> | <span data-ttu-id="bcf83-369">f20a725a-d1c8-4107-83ea-1171c97d00c7</span><span class="sxs-lookup"><span data-stu-id="bcf83-369">f20a725a-d1c8-4107-83ea-1171c97d00c7</span></span>
<span data-ttu-id="bcf83-370">報表讀者</span><span class="sxs-lookup"><span data-stu-id="bcf83-370">Reports reader</span></span> | <span data-ttu-id="bcf83-371">54635450-e8ed-4f2d-9632-07db2517b4de</span><span class="sxs-lookup"><span data-stu-id="bcf83-371">54635450-e8ed-4f2d-9632-07db2517b4de</span></span>
<span data-ttu-id="bcf83-372">搜尋管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-372">Search administrator</span></span> | <span data-ttu-id="bcf83-373">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span><span class="sxs-lookup"><span data-stu-id="bcf83-373">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span></span>
<span data-ttu-id="bcf83-374">搜尋編輯者</span><span class="sxs-lookup"><span data-stu-id="bcf83-374">Search editor</span></span> | <span data-ttu-id="bcf83-375">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span><span class="sxs-lookup"><span data-stu-id="bcf83-375">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span></span>
<span data-ttu-id="bcf83-376">安全性系統管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-376">Security administrator</span></span> | <span data-ttu-id="bcf83-377">20fa50e3-6531-44d8-bd39-b251420568ad</span><span class="sxs-lookup"><span data-stu-id="bcf83-377">20fa50e3-6531-44d8-bd39-b251420568ad</span></span>
<span data-ttu-id="bcf83-378">安全性操作員</span><span class="sxs-lookup"><span data-stu-id="bcf83-378">Security operator</span></span> | <span data-ttu-id="bcf83-379">43aae017-8e51-4188-91ab-e6debd572800</span><span class="sxs-lookup"><span data-stu-id="bcf83-379">43aae017-8e51-4188-91ab-e6debd572800</span></span>
<span data-ttu-id="bcf83-380">安全性讀取者</span><span class="sxs-lookup"><span data-stu-id="bcf83-380">Security reader</span></span> | <span data-ttu-id="bcf83-381">45035cd3-fd97-4250-8197-3a53d3562d9b</span><span class="sxs-lookup"><span data-stu-id="bcf83-381">45035cd3-fd97-4250-8197-3a53d3562d9b</span></span>
<span data-ttu-id="bcf83-382">服務支援管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-382">Service support administrator</span></span> | <span data-ttu-id="bcf83-383">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span><span class="sxs-lookup"><span data-stu-id="bcf83-383">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span></span>
<span data-ttu-id="bcf83-384">SharePoint 管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-384">SharePoint administrator</span></span> | <span data-ttu-id="bcf83-385">e1c32229-875e-461d-ae24-3cb99116e86c</span><span class="sxs-lookup"><span data-stu-id="bcf83-385">e1c32229-875e-461d-ae24-3cb99116e86c</span></span>
<span data-ttu-id="bcf83-386">商務用 Skype 的管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-386">Skype for Business administrator</span></span> | <span data-ttu-id="bcf83-387">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span><span class="sxs-lookup"><span data-stu-id="bcf83-387">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span></span>
<span data-ttu-id="bcf83-388">Microsoft Teams 通訊系統管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-388">Teams Communications Administrator</span></span> | <span data-ttu-id="bcf83-389">2393e455-6e13-4743-9f52-63fcec2b6a9c</span><span class="sxs-lookup"><span data-stu-id="bcf83-389">2393e455-6e13-4743-9f52-63fcec2b6a9c</span></span>
<span data-ttu-id="bcf83-390">Microsoft Teams 通訊支援工程師</span><span class="sxs-lookup"><span data-stu-id="bcf83-390">Teams Communications Support Engineer</span></span> | <span data-ttu-id="bcf83-391">802dd94e-d717-46f6-af98-b9167071e9fc</span><span class="sxs-lookup"><span data-stu-id="bcf83-391">802dd94e-d717-46f6-af98-b9167071e9fc</span></span>
<span data-ttu-id="bcf83-392">團隊通訊專家</span><span class="sxs-lookup"><span data-stu-id="bcf83-392">Teams Communications Specialist</span></span> | <span data-ttu-id="bcf83-393">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span><span class="sxs-lookup"><span data-stu-id="bcf83-393">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span></span>
<span data-ttu-id="bcf83-394">Microsoft Teams 服務管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-394">Teams Service Administrator</span></span> | <span data-ttu-id="bcf83-395">8846a0be-197b-443a-b13c-11192691fa24</span><span class="sxs-lookup"><span data-stu-id="bcf83-395">8846a0be-197b-443a-b13c-11192691fa24</span></span>
<span data-ttu-id="bcf83-396">使用者管理員</span><span class="sxs-lookup"><span data-stu-id="bcf83-396">User administrator</span></span> | <span data-ttu-id="bcf83-397">1f6eed58-7dd3-460b-a298-666f975427a1</span><span class="sxs-lookup"><span data-stu-id="bcf83-397">1f6eed58-7dd3-460b-a298-666f975427a1</span></span>

## <a name="additional-resources"></a><span data-ttu-id="bcf83-398">其他資源</span><span class="sxs-lookup"><span data-stu-id="bcf83-398">Additional resources</span></span>
