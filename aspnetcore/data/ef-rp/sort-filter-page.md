...
### <a name="add-column-heading-hyperlinks-to-the-student-index-page"></a><span data-ttu-id="b9db8-155">將資料行標題超連結新增至 Student 的 [索引] 頁面</span><span class="sxs-lookup"><span data-stu-id="b9db8-155">Add column heading hyperlinks to the Student Index page</span></span>
...
<span data-ttu-id="b9db8-172">使用下列程式碼取代 *Students/Index.cshtml.cs* 中的程式碼來新增篩選：</span><span class="sxs-lookup"><span data-stu-id="b9db8-172">Replace the code in *Students/Index.cshtml.cs* with the following code to add filtering:</span></span>
...
<span data-ttu-id="b9db8-208">測試應用程式：</span><span class="sxs-lookup"><span data-stu-id="b9db8-208">Test the app:</span></span>
...
<span data-ttu-id="b9db8-241">遇下列情況時，`OnGetAsync` 接收的所有參數都會成為 Null：</span><span class="sxs-lookup"><span data-stu-id="b9db8-241">All the parameters that `OnGetAsync` receives are null when:</span></span>
...
### <a name="add-paging-links"></a><span data-ttu-id="b9db8-261">新增分頁連結</span><span class="sxs-lookup"><span data-stu-id="b9db8-261">Add paging links</span></span>
...
<span data-ttu-id="b9db8-277">使用下列程式碼建立 *SchoolViewModels/EnrollmentDateGroup.cs*：</span><span class="sxs-lookup"><span data-stu-id="b9db8-277">Create *SchoolViewModels/EnrollmentDateGroup.cs* with the following code:</span></span>
...
<span data-ttu-id="b9db8-289">在本教學課程中，將新增排序、篩選、分組和分頁功能。</span><span class="sxs-lookup"><span data-stu-id="b9db8-289">In this tutorial, sorting, filtering, grouping, and paging, functionality is added.</span></span>
...
<span data-ttu-id="b9db8-307">`NameSort``DateSort`頁面會使用和 Razor 來設定具有適當查詢字串值的資料行標題超連結：</span><span class="sxs-lookup"><span data-stu-id="b9db8-307">`NameSort` and `DateSort` are used by the Razor Page to configure the column heading hyperlinks with the appropriate query string values:</span></span>
...
<span data-ttu-id="b9db8-350">將篩選新增至 Students [索引] 頁面：</span><span class="sxs-lookup"><span data-stu-id="b9db8-350">To add filtering to the Students Index page:</span></span>
...
<span data-ttu-id="b9db8-388">測試應用程式：</span><span class="sxs-lookup"><span data-stu-id="b9db8-388">Test the app:</span></span>
...
<span data-ttu-id="b9db8-445">逐步執行偵錯工具。</span><span class="sxs-lookup"><span data-stu-id="b9db8-445">Step through the debugger.</span></span>

## <a name="update-the-about-page-to-show-student-statistics"></a><span data-ttu-id="b9db8-446">更新 About 頁面以顯示學生統計資料</span><span class="sxs-lookup"><span data-stu-id="b9db8-446">Update the About page to show student statistics</span></span>

<span data-ttu-id="b9db8-447">在此步驟中，*Pages/About.cshtml* 會更新為顯示在每一個註冊日期中，共有多少學生註冊。</span><span class="sxs-lookup"><span data-stu-id="b9db8-447">In this step, *Pages/About.cshtml* is updated to display how many students have enrolled for each enrollment date.</span></span> <span data-ttu-id="b9db8-448">此更新會使用群組，並包含下列步驟：</span><span class="sxs-lookup"><span data-stu-id="b9db8-448">The update uses grouping and includes the following steps:</span></span>

* <span data-ttu-id="b9db8-449">為 **About** 頁面所使用的資料，建立檢視模型。</span><span class="sxs-lookup"><span data-stu-id="b9db8-449">Create a view model for the data used by the **About** Page.</span></span>
* <span data-ttu-id="b9db8-450">更新 About 頁面以使用檢視模型。</span><span class="sxs-lookup"><span data-stu-id="b9db8-450">Update the About page to use the view model.</span></span>

### <a name="create-the-view-model"></a><span data-ttu-id="b9db8-451">建立檢視模型</span><span class="sxs-lookup"><span data-stu-id="b9db8-451">Create the view model</span></span>

<span data-ttu-id="b9db8-452">在 *Models* 資料夾中建立 *SchoolViewModels* 資料夾。</span><span class="sxs-lookup"><span data-stu-id="b9db8-452">Create a *SchoolViewModels* folder in the *Models* folder.</span></span>

<span data-ttu-id="b9db8-453">在 *SchoolViewModels* 資料夾中，以下列程式碼新增 *EnrollmentDateGroup.cs*：</span><span class="sxs-lookup"><span data-stu-id="b9db8-453">In the *SchoolViewModels* folder, add a *EnrollmentDateGroup.cs* with the following code:</span></span>

[!code-csharp[](intro/samples/cu21/Models/SchoolViewModels/EnrollmentDateGroup.cs)]

### <a name="update-the-about-page-model"></a><span data-ttu-id="b9db8-454">更新 About 頁面模型</span><span class="sxs-lookup"><span data-stu-id="b9db8-454">Update the About page model</span></span>

<span data-ttu-id="b9db8-455">ASP.NET Core 2.2 中的 Web 範本不包括 [關於] 頁面。</span><span class="sxs-lookup"><span data-stu-id="b9db8-455">The web templates in ASP.NET Core 2.2 do not include the About page.</span></span> <span data-ttu-id="b9db8-456">如果您使用 ASP.NET Core 2.2，請建立 [About （關於）] Razor 頁面。</span><span class="sxs-lookup"><span data-stu-id="b9db8-456">If you are using ASP.NET Core 2.2, create the About Razor Page.</span></span>

<span data-ttu-id="b9db8-457">以下列程式碼更新 *Pages/About.cshtml.cs* 檔案：</span><span class="sxs-lookup"><span data-stu-id="b9db8-457">Update the *Pages/About.cshtml.cs* file with the following code:</span></span>

[!code-csharp[](intro/samples/cu21/Pages/About.cshtml.cs)]

<span data-ttu-id="b9db8-458">LINQ 陳述式會依註冊日期將學生實體組成群組、計算每個群組中的實體數目、將結果儲存在 `EnrollmentDateGroup` 檢視模型物件的集合中。</span><span class="sxs-lookup"><span data-stu-id="b9db8-458">The LINQ statement groups the student entities by enrollment date, calculates the number of entities in each group, and stores the results in a collection of `EnrollmentDateGroup` view model objects.</span></span>

### <a name="modify-the-about-razor-page"></a><span data-ttu-id="b9db8-459">修改 [About （關於）] Razor 頁面</span><span class="sxs-lookup"><span data-stu-id="b9db8-459">Modify the About Razor Page</span></span>

<span data-ttu-id="b9db8-460">以下列程式碼取代 *Pages/About.cshtml* 檔案中的程式碼：</span><span class="sxs-lookup"><span data-stu-id="b9db8-460">Replace the code in the *Pages/About.cshtml* file with the following code:</span></span>

[!code-cshtml[](intro/samples/cu21/Pages/About.cshtml)]

<span data-ttu-id="b9db8-461">執行應用程式並巡覽至 About 頁面。</span><span class="sxs-lookup"><span data-stu-id="b9db8-461">Run the app and navigate to the About page.</span></span> <span data-ttu-id="b9db8-462">每個註冊日期的學生人數將會顯示在資料表中。</span><span class="sxs-lookup"><span data-stu-id="b9db8-462">The count of students for each enrollment date is displayed in a table.</span></span>

<span data-ttu-id="b9db8-463">如果您遇到無法解決的問題，請下載[已完成的應用程式](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/data/ef-rp/intro/samples/StageSnapShots/cu-part3-sorting)。</span><span class="sxs-lookup"><span data-stu-id="b9db8-463">If you run into problems you can't solve, download the [completed app for this stage](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/data/ef-rp/intro/samples/StageSnapShots/cu-part3-sorting).</span></span>

![About 頁面](sort-filter-page/_static/about.png)

## <a name="additional-resources"></a><span data-ttu-id="b9db8-465">其他資源</span><span class="sxs-lookup"><span data-stu-id="b9db8-465">Additional resources</span></span>

* [<span data-ttu-id="b9db8-466">偵錯 ASP.NET Core 2.x 原始檔</span><span class="sxs-lookup"><span data-stu-id="b9db8-466">Debugging ASP.NET Core 2.x source</span></span>](https://github.com/dotnet/AspNetCore.Docs/issues/4155)
* [<span data-ttu-id="b9db8-467">本教學課程的 YouTube 版本</span><span class="sxs-lookup"><span data-stu-id="b9db8-467">YouTube version of this tutorial</span></span>](https://www.youtube.com/watch?v=MDs7PFpoMqI)

<span data-ttu-id="b9db8-468">在下一個教學課程中，應用程式將會使用移轉來更新資料模型。</span><span class="sxs-lookup"><span data-stu-id="b9db8-468">In the next tutorial, the app uses migrations to update the data model.</span></span>

> [!div class="step-by-step"]
> <span data-ttu-id="b9db8-469">[上一個](xref:data/ef-rp/crud) 
> [下一步](xref:data/ef-rp/migrations)</span><span class="sxs-lookup"><span data-stu-id="b9db8-469">[Previous](xref:data/ef-rp/crud)
