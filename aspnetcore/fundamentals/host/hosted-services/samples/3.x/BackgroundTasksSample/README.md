# <a name="aspnet-core-background-tasks-sample"></a><span data-ttu-id="85c4e-101">ASP.NET Core 背景工作範例</span><span class="sxs-lookup"><span data-stu-id="85c4e-101">ASP.NET Core Background Tasks Sample</span></span>
