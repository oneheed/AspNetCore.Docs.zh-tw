# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="57383-101">ASP.NET Core URL 重寫範例</span><span class="sxs-lookup"><span data-stu-id="57383-101">ASP.NET Core URL Rewriting Sample</span></span>
