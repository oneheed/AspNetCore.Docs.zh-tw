<span data-ttu-id="9fe6c-101">如果尚未 `dotnet ef` 安裝，請將其安裝為通用工具：</span><span class="sxs-lookup"><span data-stu-id="9fe6c-101">If `dotnet ef` has not been installed, install it as a global tool:</span></span>
