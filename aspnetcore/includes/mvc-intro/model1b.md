<span data-ttu-id="5e045-101">將下列屬性新增至 `Movie` 類別：</span><span class="sxs-lookup"><span data-stu-id="5e045-101">Add the following properties to the `Movie` class:</span></span>
