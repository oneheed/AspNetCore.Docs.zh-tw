<span data-ttu-id="4cfc7-101">將下列屬性新增至 `Movie` 類別：</span><span class="sxs-lookup"><span data-stu-id="4cfc7-101">Add the following properties to the `Movie` class:</span></span>
