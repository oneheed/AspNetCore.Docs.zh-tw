<span data-ttu-id="5e545-101">Visual Studio for Mac 會顯示下列快顯視窗：</span><span class="sxs-lookup"><span data-stu-id="5e545-101">Visual Studio for Mac displays the following popup:</span></span>
