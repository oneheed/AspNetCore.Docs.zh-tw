...
`SameSite`HTTP s 的屬性（attribute）會在 cookie ASP.NET Core 3.0 和3.1 之間變更。 如需採取動作，請參閱下列資源：

* <xref:security/samesite>
* [aspnet/公告 # 390](https://github.com/aspnet/Announcements/issues/390)
* [cookieASP.NET 和 ASP.NET Core 即將推出的 SameSite 變更](https://devblogs.microsoft.com/aspnet/upcoming-samesite-cookie-changes-in-asp-net-and-asp-net-core/)
