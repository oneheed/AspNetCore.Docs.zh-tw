...
如果要更新 Blazor WebAssembly 專案，請跳至[更新 Blazor WebAssembly 專案](#update-blazor-webassembly-projects)一節。 針對任何其他 ASP.NET Core 專案類型，請將專案檔的[目標 Framework 標記 (TFM) ](/dotnet/standard/frameworks)更新為 `net5.0` ：
