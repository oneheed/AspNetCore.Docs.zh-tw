...
---
# <a name="aspnet-core-no-locsignalr-net-client"></a>ASP.NET Core SignalR .Net 用戶端
...
## <a name="install-the-no-locsignalr-net-client-package"></a>安裝 SignalR .net 用戶端套件
...
若要安裝用戶端程式庫，請在 **封裝管理員主控台** 視窗中執行下列命令：
