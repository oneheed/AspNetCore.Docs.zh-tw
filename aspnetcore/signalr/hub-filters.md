...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="f7509-103">使用 ASP.NET Core 中的中樞篩選 SignalR</span><span class="sxs-lookup"><span data-stu-id="f7509-103">Use hub filters in ASP.NET Core SignalR</span></span>
