...
## <a name="get-an-instance-of-no-locihubcontext"></a>取得的實例 IHubContext
...
### <a name="inject-an-instance-of-no-locihubcontext-in-a-controller"></a>IHubContext在控制器中插入的實例
...
### <a name="get-an-instance-of-no-locihubcontext-in-middleware"></a>IHubContext在中介軟體中取得的實例
...
### <a name="get-an-instance-of-no-locihubcontext-from-ihost"></a>從 IHost 取得的實例 IHubContext
