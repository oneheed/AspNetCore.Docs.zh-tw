...
ms.locfileid: "93066729"
---
# <a name="send-messages-from-outside-a-hub"></a><span data-ttu-id="db715-103">從中樞外部傳送訊息</span><span class="sxs-lookup"><span data-stu-id="db715-103">Send messages from outside a hub</span></span>
...
<span data-ttu-id="db715-127">如需詳細資訊，請參閱 [強型別中樞](xref:signalr/hubs#strongly-typed-hubs) 。</span><span class="sxs-lookup"><span data-stu-id="db715-127">See [Strongly typed hubs](xref:signalr/hubs#strongly-typed-hubs) for more information.</span></span>

## <a name="related-resources"></a><span data-ttu-id="db715-128">相關資源</span><span class="sxs-lookup"><span data-stu-id="db715-128">Related resources</span></span>

* [<span data-ttu-id="db715-129">開始使用</span><span class="sxs-lookup"><span data-stu-id="db715-129">Get started</span></span>](xref:tutorials/signalr)
* [<span data-ttu-id="db715-130">中樞</span><span class="sxs-lookup"><span data-stu-id="db715-130">Hubs</span></span>](xref:signalr/hubs)
* [<span data-ttu-id="db715-131">發佈至 Azure</span><span class="sxs-lookup"><span data-stu-id="db715-131">Publish to Azure</span></span>](xref:signalr/publish-to-azure-web-app)
