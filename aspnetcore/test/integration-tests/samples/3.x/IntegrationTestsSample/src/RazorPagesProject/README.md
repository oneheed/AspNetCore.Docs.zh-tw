# <a name="aspnet-core-integration-testing-sample"></a><span data-ttu-id="764c9-101">ASP.NET Core 整合測試範例</span><span class="sxs-lookup"><span data-stu-id="764c9-101">ASP.NET Core Integration Testing Sample</span></span>
