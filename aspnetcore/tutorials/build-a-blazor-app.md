...
---
# <a name="build-a-no-locblazor-todo-list-app"></a><span data-ttu-id="1d539-103">建立 :::no-loc(Blazor)::: 待辦事項清單應用程式</span><span class="sxs-lookup"><span data-stu-id="1d539-103">Build a :::no-loc(Blazor)::: todo list app</span></span>
...
<span data-ttu-id="1d539-105">本教學課程說明如何建立和修改 :::no-loc(Blazor)::: 應用程式。</span><span class="sxs-lookup"><span data-stu-id="1d539-105">This tutorial shows you how to build and modify a :::no-loc(Blazor)::: app.</span></span> <span data-ttu-id="1d539-106">您會了解如何：</span><span class="sxs-lookup"><span data-stu-id="1d539-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="1d539-107">建立待辦事項清單 :::no-loc(Blazor)::: 應用程式專案</span><span class="sxs-lookup"><span data-stu-id="1d539-107">Create a todo list :::no-loc(Blazor)::: app project</span></span>
> * <span data-ttu-id="1d539-108">修改 :::no-loc(Razor)::: 元件</span><span class="sxs-lookup"><span data-stu-id="1d539-108">Modify :::no-loc(Razor)::: components</span></span>
...
> * <span data-ttu-id="1d539-110">在應用程式中使用路由 :::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="1d539-110">Use routing in a :::no-loc(Blazor)::: app</span></span>
...
## <a name="create-a-todo-list-no-locblazor-app"></a><span data-ttu-id="1d539-113">建立 todo 清單 :::no-loc(Blazor)::: 應用程式</span><span class="sxs-lookup"><span data-stu-id="1d539-113">Create a todo list :::no-loc(Blazor)::: app</span></span>

1. <span data-ttu-id="1d539-114">:::no-loc(Blazor):::在命令列介面中建立名為的新應用程式 `TodoList` ：</span><span class="sxs-lookup"><span data-stu-id="1d539-114">Create a new :::no-loc(Blazor)::: app named `TodoList` in a command shell:</span></span>
...
1. <span data-ttu-id="1d539-118">`Todo` :::no-loc(Razor)::: 使用下列命令，在資料夾中將新元件新增至應用程式 `Pages` ：</span><span class="sxs-lookup"><span data-stu-id="1d539-118">Add a new `Todo` :::no-loc(Razor)::: component to the app in the `Pages` folder using the following command:</span></span>
   ...
   > [!IMPORTANT]
   > <span data-ttu-id="1d539-119">:::no-loc(Razor)::: 元件檔案名需要大寫的第一個字母。</span><span class="sxs-lookup"><span data-stu-id="1d539-119">:::no-loc(Razor)::: component file names require a capitalized first letter.</span></span> <span data-ttu-id="1d539-120">開啟 `Pages` 資料夾，並確認 `Todo` 元件檔案名以大寫字母開頭 `T` 。</span><span class="sxs-lookup"><span data-stu-id="1d539-120">Open the `Pages` folder and confirm that the `Todo` component file name starts with a capital letter `T`.</span></span> <span data-ttu-id="1d539-121">檔案名應該是 `Todo.razor` 。</span><span class="sxs-lookup"><span data-stu-id="1d539-121">The file name should be `Todo.razor`.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="1d539-159">建立待辦事項清單 :::no-loc(Blazor)::: 應用程式專案</span><span class="sxs-lookup"><span data-stu-id="1d539-159">Create a todo list :::no-loc(Blazor)::: app project</span></span>
> * <span data-ttu-id="1d539-160">修改 :::no-loc(Razor)::: 元件</span><span class="sxs-lookup"><span data-stu-id="1d539-160">Modify :::no-loc(Razor)::: components</span></span>
...
> * <span data-ttu-id="1d539-162">在應用程式中使用路由 :::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="1d539-162">Use routing in a :::no-loc(Blazor)::: app</span></span>

<span data-ttu-id="1d539-163">瞭解 ASP.NET Core 的工具 :::no-loc(Blazor)::: ：</span><span class="sxs-lookup"><span data-stu-id="1d539-163">Learn about tooling for ASP.NET Core :::no-loc(Blazor)::::</span></span>
