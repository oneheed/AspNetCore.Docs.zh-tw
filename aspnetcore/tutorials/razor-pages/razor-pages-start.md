...
## <a name="prerequisites"></a><span data-ttu-id="8359b-115">必要條件</span><span class="sxs-lookup"><span data-stu-id="8359b-115">Prerequisites</span></span>

# <a name="visual-studio"></a>[<span data-ttu-id="8359b-116">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="8359b-116">Visual Studio</span></span>](#tab/visual-studio)

[!INCLUDE[](~/includes/net-core-prereqs-vs-5.0.md)]

# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-117">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-117">Visual Studio Code</span></span>](#tab/visual-studio-code)

[!INCLUDE[](~/includes/net-core-prereqs-vsc-5.0.md)]

# <a name="visual-studio-for-mac"></a>[<span data-ttu-id="8359b-118">Visual Studio for Mac</span><span class="sxs-lookup"><span data-stu-id="8359b-118">Visual Studio for Mac</span></span>](#tab/visual-studio-mac)
...
1. <span data-ttu-id="8359b-130">在 **Create 新的 ASP.NET Core web 應用程式** ] 對話方塊中，選取：</span><span class="sxs-lookup"><span data-stu-id="8359b-130">In the **Create a new ASP.NET Core web application** dialog, select:</span></span>
    ...
    <span data-ttu-id="8359b-135">下列起始專案會隨即建立：</span><span class="sxs-lookup"><span data-stu-id="8359b-135">The following starter project is created:</span></span>

    ![方案總管](razor-pages-start/_static/se2.2.png)

# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-137">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-137">Visual Studio Code</span></span>](#tab/visual-studio-code)

1. <span data-ttu-id="8359b-138">開啟 [整合式終端](https://code.visualstudio.com/docs/editor/integrated-terminal)機。</span><span class="sxs-lookup"><span data-stu-id="8359b-138">Open the [integrated terminal](https://code.visualstudio.com/docs/editor/integrated-terminal).</span></span>

1. <span data-ttu-id="8359b-139">變更為將包含專案的目錄 (`cd`)。</span><span class="sxs-lookup"><span data-stu-id="8359b-139">Change to the directory (`cd`) which will contain the project.</span></span>
...
1. <span data-ttu-id="8359b-144">選取 [檔案] **[新增解決方案]** > 。</span><span class="sxs-lookup"><span data-stu-id="8359b-144">Select **File** > **New Solution**.</span></span>

    ![macOS 新增方案](../first-mvc-app/start-mvc/_static/new_project_vsmac.png)

1. <span data-ttu-id="8359b-146">在8.6 版之前的 Visual Studio for Mac 中，請選取 [ **.net Core**  >  **應用**  >  **程式 Web 應用程式**  >  **]** 。</span><span class="sxs-lookup"><span data-stu-id="8359b-146">In Visual Studio for Mac earlier than version 8.6, select **.NET Core** > **App** > **Web Application** > **Next**.</span></span> <span data-ttu-id="8359b-147">在8.6 版或更新版本中，請選取 [ **web] 和 [主控台**  >  **應用**  >  **程式 web 應用程式**  >  **]** 。</span><span class="sxs-lookup"><span data-stu-id="8359b-147">In version 8.6 or later, select **Web and Console** > **App** > **Web Application** > **Next**.</span></span>

    ![macOS web 應用程式範本選取專案](razor-pages-start/_static/web_app_template_vsmac.png)

1. <span data-ttu-id="8359b-149">在 [ **設定新的 Web 應用程式** ] 對話方塊中：</span><span class="sxs-lookup"><span data-stu-id="8359b-149">In the **Configure the new Web Application** dialog:</span></span>

    1. <span data-ttu-id="8359b-150">確認 [ **驗證** ] 設定為 [ **無驗證** ]。</span><span class="sxs-lookup"><span data-stu-id="8359b-150">Confirm that **Authentication** is set to **No Authentication**.</span></span>
...
## <a name="run-the-app"></a><span data-ttu-id="8359b-155">執行應用程式</span><span class="sxs-lookup"><span data-stu-id="8359b-155">Run the app</span></span>

  [!INCLUDE[](~/includes/run-the-app.md)]

## <a name="examine-the-project-files"></a><span data-ttu-id="8359b-156">檢查專案檔</span><span class="sxs-lookup"><span data-stu-id="8359b-156">Examine the project files</span></span>

<span data-ttu-id="8359b-157">以下概要說明主要專案資料夾和檔案，您將在稍後的教學課程中使用這些資料夾和檔案。</span><span class="sxs-lookup"><span data-stu-id="8359b-157">Here's an overview of the main project folders and files that you'll work with in later tutorials.</span></span>
...
### <a name="wwwroot-folder"></a><span data-ttu-id="8359b-167">wwwroot 資料夾</span><span class="sxs-lookup"><span data-stu-id="8359b-167">wwwroot folder</span></span>
...
### <a name="programcs"></a><span data-ttu-id="8359b-172">Program.cs</span><span class="sxs-lookup"><span data-stu-id="8359b-172">Program.cs</span></span>

<span data-ttu-id="8359b-173">包含應用程式的進入點。</span><span class="sxs-lookup"><span data-stu-id="8359b-173">Contains the entry point for the app.</span></span> <span data-ttu-id="8359b-174">如需詳細資訊，請參閱<xref:fundamentals/host/generic-host>。</span><span class="sxs-lookup"><span data-stu-id="8359b-174">For more information, see <xref:fundamentals/host/generic-host>.</span></span>

### <a name="startupcs"></a><span data-ttu-id="8359b-175">Startup.cs</span><span class="sxs-lookup"><span data-stu-id="8359b-175">Startup.cs</span></span>

<span data-ttu-id="8359b-176">包含設定應用程式行為的程式碼。</span><span class="sxs-lookup"><span data-stu-id="8359b-176">Contains code that configures app behavior.</span></span> <span data-ttu-id="8359b-177">如需詳細資訊，請參閱<xref:fundamentals/startup>。</span><span class="sxs-lookup"><span data-stu-id="8359b-177">For more information, see <xref:fundamentals/startup>.</span></span>

## <a name="next-steps"></a><span data-ttu-id="8359b-178">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8359b-178">Next steps</span></span>

> [!div class="step-by-step"]
> [<span data-ttu-id="8359b-179">下一步：新增模型</span><span class="sxs-lookup"><span data-stu-id="8359b-179">Next: Add a model</span></span>](xref:tutorials/razor-pages/model)
...
## <a name="prerequisites"></a><span data-ttu-id="8359b-190">必要條件</span><span class="sxs-lookup"><span data-stu-id="8359b-190">Prerequisites</span></span>

# <a name="visual-studio"></a>[<span data-ttu-id="8359b-191">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="8359b-191">Visual Studio</span></span>](#tab/visual-studio)

[!INCLUDE[](~/includes/net-core-prereqs-vs-3.1.md)]

# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-192">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-192">Visual Studio Code</span></span>](#tab/visual-studio-code)

[!INCLUDE[](~/includes/net-core-prereqs-vsc-3.1.md)]

# <a name="visual-studio-for-mac"></a>[<span data-ttu-id="8359b-193">Visual Studio for Mac</span><span class="sxs-lookup"><span data-stu-id="8359b-193">Visual Studio for Mac</span></span>](#tab/visual-studio-mac)
...
![新增 ASP.NET Core Web 應用程式](razor-pages-start/_static/3/npx.png)
  ...
  <span data-ttu-id="8359b-204">下列起始專案會隨即建立：</span><span class="sxs-lookup"><span data-stu-id="8359b-204">The following starter project is created:</span></span>

  ![方案總管](razor-pages-start/_static/se2.2.png)

# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-206">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-206">Visual Studio Code</span></span>](#tab/visual-studio-code)

* <span data-ttu-id="8359b-207">開啟 [整合式終端](https://code.visualstudio.com/docs/editor/integrated-terminal)機。</span><span class="sxs-lookup"><span data-stu-id="8359b-207">Open the [integrated terminal](https://code.visualstudio.com/docs/editor/integrated-terminal).</span></span>

* <span data-ttu-id="8359b-208">變更為將包含專案的目錄 (`cd`)。</span><span class="sxs-lookup"><span data-stu-id="8359b-208">Change to the directory (`cd`) which will contain the project.</span></span>
...
# <a name="visual-studio-for-mac"></a>[<span data-ttu-id="8359b-215">Visual Studio for Mac</span><span class="sxs-lookup"><span data-stu-id="8359b-215">Visual Studio for Mac</span></span>](#tab/visual-studio-mac)

* <span data-ttu-id="8359b-216">選取 [檔案] **[新增解決方案]** > 。</span><span class="sxs-lookup"><span data-stu-id="8359b-216">Select **File** > **New Solution**.</span></span>

  ![macOS 新增方案](../first-mvc-app/start-mvc/_static/new_project_vsmac.png)

* <span data-ttu-id="8359b-218">在8.6 版之前的 Visual Studio for Mac 中，請選取 [ **.net Core**  >  **應用**  >  **程式 Web 應用程式**  >  **]** 。</span><span class="sxs-lookup"><span data-stu-id="8359b-218">In Visual Studio for Mac earlier than version 8.6, select **.NET Core** > **App** > **Web Application** > **Next**.</span></span> <span data-ttu-id="8359b-219">在8.6 版或更新版本中，請選取 [ **web] 和 [主控台**  >  **應用**  >  **程式 web 應用程式**  >  **]** 。</span><span class="sxs-lookup"><span data-stu-id="8359b-219">In version 8.6 or later, select **Web and Console** > **App** > **Web Application** > **Next**.</span></span>

  ![macOS web 應用程式範本選取專案](razor-pages-start/_static/web_app_template_vsmac.png)

* <span data-ttu-id="8359b-221">在 [ **設定新的 Web 應用程式** ] 對話方塊中：</span><span class="sxs-lookup"><span data-stu-id="8359b-221">In the **Configure the new Web Application** dialog:</span></span>

  * <span data-ttu-id="8359b-222">確認 [ **驗證** ] 設定為 [ **無驗證** ]。</span><span class="sxs-lookup"><span data-stu-id="8359b-222">Confirm that **Authentication** is set to **No Authentication**.</span></span>
  * <span data-ttu-id="8359b-223">如果有選取 **目標 Framework** 的選項，請選取最新的3.x 版。</span><span class="sxs-lookup"><span data-stu-id="8359b-223">If presented an option to select a **Target Framework** , select the latest 3.x version.</span></span>
...
## <a name="run-the-app"></a><span data-ttu-id="8359b-227">執行應用程式</span><span class="sxs-lookup"><span data-stu-id="8359b-227">Run the app</span></span>

  [!INCLUDE[](~/includes/run-the-app.md)]

## <a name="examine-the-project-files"></a><span data-ttu-id="8359b-228">檢查專案檔</span><span class="sxs-lookup"><span data-stu-id="8359b-228">Examine the project files</span></span>

<span data-ttu-id="8359b-229">以下概要說明主要專案資料夾和檔案，您將在稍後的教學課程中使用這些資料夾和檔案。</span><span class="sxs-lookup"><span data-stu-id="8359b-229">Here's an overview of the main project folders and files that you'll work with in later tutorials.</span></span>
...
### <a name="wwwroot-folder"></a><span data-ttu-id="8359b-239">wwwroot 資料夾</span><span class="sxs-lookup"><span data-stu-id="8359b-239">wwwroot folder</span></span>

<span data-ttu-id="8359b-240">包含靜態檔案，例如 HTML 檔案、JavaScript 檔案和 CSS 檔案。</span><span class="sxs-lookup"><span data-stu-id="8359b-240">Contains static files, like HTML files, JavaScript files, and CSS files.</span></span> <span data-ttu-id="8359b-241">如需詳細資訊，請參閱<xref:fundamentals/static-files>。</span><span class="sxs-lookup"><span data-stu-id="8359b-241">For more information, see <xref:fundamentals/static-files>.</span></span>

### <a name="appsettingsjson"></a><span data-ttu-id="8359b-242">appSettings.json</span><span class="sxs-lookup"><span data-stu-id="8359b-242">appSettings.json</span></span>

<span data-ttu-id="8359b-243">包含設定資料，例如連接字串。</span><span class="sxs-lookup"><span data-stu-id="8359b-243">Contains configuration data, like connection strings.</span></span> <span data-ttu-id="8359b-244">如需詳細資訊，請參閱<xref:fundamentals/configuration/index>。</span><span class="sxs-lookup"><span data-stu-id="8359b-244">For more information, see <xref:fundamentals/configuration/index>.</span></span>

### <a name="programcs"></a><span data-ttu-id="8359b-245">Program.cs</span><span class="sxs-lookup"><span data-stu-id="8359b-245">Program.cs</span></span>

<span data-ttu-id="8359b-246">包含程式的進入點。</span><span class="sxs-lookup"><span data-stu-id="8359b-246">Contains the entry point for the program.</span></span> <span data-ttu-id="8359b-247">如需詳細資訊，請參閱<xref:fundamentals/host/generic-host>。</span><span class="sxs-lookup"><span data-stu-id="8359b-247">For more information, see <xref:fundamentals/host/generic-host>.</span></span>

### <a name="startupcs"></a><span data-ttu-id="8359b-248">Startup.cs</span><span class="sxs-lookup"><span data-stu-id="8359b-248">Startup.cs</span></span>

<span data-ttu-id="8359b-249">包含設定應用程式行為的程式碼。</span><span class="sxs-lookup"><span data-stu-id="8359b-249">Contains code that configures app behavior.</span></span> <span data-ttu-id="8359b-250">如需詳細資訊，請參閱<xref:fundamentals/startup>。</span><span class="sxs-lookup"><span data-stu-id="8359b-250">For more information, see <xref:fundamentals/startup>.</span></span>

## <a name="next-steps"></a><span data-ttu-id="8359b-251">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8359b-251">Next steps</span></span>

> [!div class="step-by-step"]
> [<span data-ttu-id="8359b-252">下一步：新增模型</span><span class="sxs-lookup"><span data-stu-id="8359b-252">Next: Add a model</span></span>](xref:tutorials/razor-pages/model)
...
<span data-ttu-id="8359b-257">[檢視或下載範例程式碼](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start) ([如何下載](xref:index#how-to-download-a-sample))。</span><span class="sxs-lookup"><span data-stu-id="8359b-257">[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start) ([how to download](xref:index#how-to-download-a-sample)).</span></span>
...
## <a name="prerequisites"></a><span data-ttu-id="8359b-264">必要條件</span><span class="sxs-lookup"><span data-stu-id="8359b-264">Prerequisites</span></span>

# <a name="visual-studio"></a>[<span data-ttu-id="8359b-265">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="8359b-265">Visual Studio</span></span>](#tab/visual-studio)

[!INCLUDE[](~/includes/net-core-prereqs-vs2019-2.2.md)]

# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-266">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-266">Visual Studio Code</span></span>](#tab/visual-studio-code)

[!INCLUDE[](~/includes/net-core-prereqs-vsc-2.2.md)]

# <a name="visual-studio-for-mac"></a>[<span data-ttu-id="8359b-267">Visual Studio for Mac</span><span class="sxs-lookup"><span data-stu-id="8359b-267">Visual Studio for Mac</span></span>](#tab/visual-studio-mac)
...
![新增 ASP.NET Core Web 應用程式](razor-pages-start/_static/np_2_2.2.png)
  ...
  <span data-ttu-id="8359b-278">下列起始專案會隨即建立：</span><span class="sxs-lookup"><span data-stu-id="8359b-278">The following starter project is created:</span></span>

  ![方案總管](razor-pages-start/_static/se2.2.png)

# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-280">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-280">Visual Studio Code</span></span>](#tab/visual-studio-code)

* <span data-ttu-id="8359b-281">開啟 [整合式終端](https://code.visualstudio.com/docs/editor/integrated-terminal)機。</span><span class="sxs-lookup"><span data-stu-id="8359b-281">Open the [integrated terminal](https://code.visualstudio.com/docs/editor/integrated-terminal).</span></span>

* <span data-ttu-id="8359b-282">變更為將包含專案的目錄 (`cd`)。</span><span class="sxs-lookup"><span data-stu-id="8359b-282">Change to the directory (`cd`) which will contain the project.</span></span>
...
# <a name="visual-studio-for-mac"></a>[<span data-ttu-id="8359b-289">Visual Studio for Mac</span><span class="sxs-lookup"><span data-stu-id="8359b-289">Visual Studio for Mac</span></span>](#tab/visual-studio-mac)

* <span data-ttu-id="8359b-290">選取 [檔案] **[新增解決方案]** > 。</span><span class="sxs-lookup"><span data-stu-id="8359b-290">Select **File** > **New Solution**.</span></span>

![macOS 新增方案](../first-mvc-app/start-mvc/_static/new_project_vsmac.png)

* <span data-ttu-id="8359b-292">在8.6 版之前的 Visual Studio for Mac 中，請選取 [ **.net Core**  >  **應用**  >  **程式 Web 應用程式**  >  **]** 。</span><span class="sxs-lookup"><span data-stu-id="8359b-292">In Visual Studio for Mac earlier than version 8.6, select **.NET Core** > **App** > **Web Application** > **Next**.</span></span> <span data-ttu-id="8359b-293">在8.6 版或更新版本中，請選取 [ **web] 和 [主控台**  >  **應用**  >  **程式 web 應用程式**  >  **]** 。</span><span class="sxs-lookup"><span data-stu-id="8359b-293">In version 8.6 or later, select **Web and Console** > **App** > **Web Application** > **Next**.</span></span>

* <span data-ttu-id="8359b-294">在 [ **設定新的 Web 應用程式** ] 對話方塊中：</span><span class="sxs-lookup"><span data-stu-id="8359b-294">In the **Configure the new Web Application** dialog:</span></span>

  * <span data-ttu-id="8359b-295">確認 [ **驗證** ] 設定為 [ **無驗證** ]。</span><span class="sxs-lookup"><span data-stu-id="8359b-295">Confirm that **Authentication** is set to **No Authentication**.</span></span>
  * <span data-ttu-id="8359b-296">如果有選取 **目標 Framework** 的選項，請選取最新的2.x 版本。</span><span class="sxs-lookup"><span data-stu-id="8359b-296">If presented an option to select a **Target Framework** , select the latest 2.x version.</span></span>
...
## <a name="run-the-app"></a><span data-ttu-id="8359b-300">執行應用程式</span><span class="sxs-lookup"><span data-stu-id="8359b-300">Run the app</span></span>

# <a name="visual-studio"></a>[<span data-ttu-id="8359b-301">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="8359b-301">Visual Studio</span></span>](#tab/visual-studio)

* <span data-ttu-id="8359b-302">按 Ctrl+F5 即可執行而不使用偵錯工具。</span><span class="sxs-lookup"><span data-stu-id="8359b-302">Press Ctrl+F5 to run without the debugger.</span></span>

  <span data-ttu-id="8359b-303">使用 <kbd>Ctrl + F5</kbd> 啟動應用程式 (非 debug 模式) 可讓您進行程式碼變更、儲存檔案、重新整理瀏覽器，以及查看程式碼變更。</span><span class="sxs-lookup"><span data-stu-id="8359b-303">Launching the app with <kbd>Ctrl+F5</kbd> (non-debug mode) allows you to make code changes, save the file, refresh the browser, and see the code changes.</span></span> <span data-ttu-id="8359b-304">許多開發人員偏好使用非偵錯模式來快速啟動應用程式並檢視變更。</span><span class="sxs-lookup"><span data-stu-id="8359b-304">Many developers prefer to use non-debug mode to quickly launch the app and view changes.</span></span>


  [!INCLUDE[](~/includes/trustCertVS.md)]

  <span data-ttu-id="8359b-305">Visual Studio 會啟動 [IIS Express](/iis/extensions/introduction-to-iis-express/iis-express-overview)，並執行應用程式。</span><span class="sxs-lookup"><span data-stu-id="8359b-305">Visual Studio starts [IIS Express](/iis/extensions/introduction-to-iis-express/iis-express-overview) and runs the app.</span></span> <span data-ttu-id="8359b-306">位址列會顯示 `localhost:port#`，而不是類似於 `example.com` 的內容。</span><span class="sxs-lookup"><span data-stu-id="8359b-306">The address bar shows `localhost:port#` and not something like `example.com`.</span></span> <span data-ttu-id="8359b-307">這是因為 `localhost` 是本機電腦的標準主機名稱。</span><span class="sxs-lookup"><span data-stu-id="8359b-307">That's because `localhost` is the standard hostname for the local computer.</span></span> <span data-ttu-id="8359b-308">Localhost 只會為來自本機電腦的 Web 要求提供服務。</span><span class="sxs-lookup"><span data-stu-id="8359b-308">Localhost only serves web requests from the local computer.</span></span> <span data-ttu-id="8359b-309">當 Visual Studio 建立 Web 專案時，會為網頁伺服器使用隨機連接埠。</span><span class="sxs-lookup"><span data-stu-id="8359b-309">When Visual Studio creates a web project, a random port is used for the web server.</span></span>

* <span data-ttu-id="8359b-310">在應用程式的首頁上，選取 [接受] 同意追蹤。</span><span class="sxs-lookup"><span data-stu-id="8359b-310">On the app's home page, select **Accept** to consent to tracking.</span></span>

  <span data-ttu-id="8359b-311">此應用程式不會追蹤個人資訊，但專案範本會包含同意功能，以防您需要同意才符合歐盟的[一般資料保護規定 (GDPR)](xref:security/gdpr)。</span><span class="sxs-lookup"><span data-stu-id="8359b-311">This app doesn't track personal information, but the project template includes the consent feature in case you need it to comply with the European Union's [General Data Protection Regulation (GDPR)](xref:security/gdpr).</span></span>

  ![Home 或：：：非 loc (Index) ：：： page](razor-pages-start/_static/homeGDPR2.2.png)

  <span data-ttu-id="8359b-313">下圖顯示同意追蹤之後的應用程式：</span><span class="sxs-lookup"><span data-stu-id="8359b-313">The following image shows the app after consent to tracking is provided:</span></span>

  ![Home 或：：：非 loc (Index) ：：： page](razor-pages-start/_static/home2.2.png)
  
# <a name="visual-studio-code"></a>[<span data-ttu-id="8359b-315">Visual Studio Code</span><span class="sxs-lookup"><span data-stu-id="8359b-315">Visual Studio Code</span></span>](#tab/visual-studio-code)

  [!INCLUDE[](~/includes/trustCertVSC.md)]

* <span data-ttu-id="8359b-316">按 <kbd>Ctrl + F5</kbd> ，在沒有偵錯工具的情況下執行。</span><span class="sxs-lookup"><span data-stu-id="8359b-316">Press <kbd>Ctrl+F5</kbd> to run without the debugger.</span></span>

  <span data-ttu-id="8359b-317">使用 <kbd>Ctrl + F5</kbd> 啟動應用程式 (非 debug 模式) 可讓您進行程式碼變更、儲存檔案、重新整理瀏覽器，以及查看程式碼變更。</span><span class="sxs-lookup"><span data-stu-id="8359b-317">Launching the app with <kbd>Ctrl+F5</kbd> (non-debug mode) allows you to make code changes, save the file, refresh the browser, and see the code changes.</span></span> <span data-ttu-id="8359b-318">許多開發人員偏好使用非偵錯模式來快速啟動應用程式並檢視變更。</span><span class="sxs-lookup"><span data-stu-id="8359b-318">Many developers prefer to use non-debug mode to quickly launch the app and view changes.</span></span>

  <span data-ttu-id="8359b-319">Visual Studio Code 開始 [Kestrel](xref:fundamentals/servers/kestrel)、啟動瀏覽器，然後移至 `http://localhost:5001` 。</span><span class="sxs-lookup"><span data-stu-id="8359b-319">Visual Studio Code starts [Kestrel](xref:fundamentals/servers/kestrel), launches a browser, and goes to `http://localhost:5001`.</span></span> <span data-ttu-id="8359b-320">位址列會顯示 `localhost:port#`，而不是類似於 `example.com` 的內容。</span><span class="sxs-lookup"><span data-stu-id="8359b-320">The address bar shows `localhost:port#` and not something like `example.com`.</span></span> <span data-ttu-id="8359b-321">這是因為 `localhost` 是本機電腦的標準主機名稱。</span><span class="sxs-lookup"><span data-stu-id="8359b-321">That's because `localhost` is the standard hostname for the local computer.</span></span> <span data-ttu-id="8359b-322">Localhost 只會為來自本機電腦的 Web 要求提供服務。</span><span class="sxs-lookup"><span data-stu-id="8359b-322">Localhost only serves web requests from the local computer.</span></span>

* <span data-ttu-id="8359b-323">在應用程式的首頁上，選取 [接受] 同意追蹤。</span><span class="sxs-lookup"><span data-stu-id="8359b-323">On the app's home page, select **Accept** to consent to tracking.</span></span>

  <span data-ttu-id="8359b-324">此應用程式不會追蹤個人資訊，但專案範本會包含同意功能，以防您需要同意才符合歐盟的[一般資料保護規定 (GDPR)](xref:security/gdpr)。</span><span class="sxs-lookup"><span data-stu-id="8359b-324">This app doesn't track personal information, but the project template includes the consent feature in case you need it to comply with the European Union's [General Data Protection Regulation (GDPR)](xref:security/gdpr).</span></span>

  ![Home 或：：：非 loc (Index) ：：： page](razor-pages-start/_static/homeGDPR2.2.png)

  <span data-ttu-id="8359b-326">下圖顯示您同意追蹤之後的應用程式：</span><span class="sxs-lookup"><span data-stu-id="8359b-326">The following image shows the app after you give consent to tracking:</span></span>

  ![Home 或：：：非 loc (Index) ：：： page](razor-pages-start/_static/home2.2.png)
  
# <a name="visual-studio-for-mac"></a>[<span data-ttu-id="8359b-328">Visual Studio for Mac</span><span class="sxs-lookup"><span data-stu-id="8359b-328">Visual Studio for Mac</span></span>](#tab/visual-studio-mac)

  [!INCLUDE[](~/includes/trustCertMac.md)]

* <span data-ttu-id="8359b-329">按 **Cmd-Opt-F5** 以在不使用偵錯工具的情況下執行。</span><span class="sxs-lookup"><span data-stu-id="8359b-329">Press **Cmd-Opt-F5** to run without the debugger.</span></span>

  <span data-ttu-id="8359b-330">使用 <kbd>Cmd + Opt + F5</kbd> (非偵測模式啟動應用程式) 可讓您進行程式碼變更、儲存檔案、重新整理瀏覽器，以及查看程式碼變更。</span><span class="sxs-lookup"><span data-stu-id="8359b-330">Launching the app with <kbd>Cmd+Opt+F5</kbd> (non-debug mode) allows you to make code changes, save the file, refresh the browser, and see the code changes.</span></span> <span data-ttu-id="8359b-331">許多開發人員偏好使用非偵錯模式來快速啟動應用程式並檢視變更。</span><span class="sxs-lookup"><span data-stu-id="8359b-331">Many developers prefer to use non-debug mode to quickly launch the app and view changes.</span></span>

  <span data-ttu-id="8359b-332">Visual Studio 開始 [Kestrel](xref:fundamentals/servers/kestrel)、啟動瀏覽器，然後移至 `http://localhost:5001` 。</span><span class="sxs-lookup"><span data-stu-id="8359b-332">Visual Studio starts [Kestrel](xref:fundamentals/servers/kestrel), launches a browser, and goes to `http://localhost:5001`.</span></span>

* <span data-ttu-id="8359b-333">在應用程式的首頁上，選取 [接受] 同意追蹤。</span><span class="sxs-lookup"><span data-stu-id="8359b-333">On the app's home page, select **Accept** to consent to tracking.</span></span>

  <span data-ttu-id="8359b-334">此應用程式不會追蹤個人資訊，但專案範本會包含同意功能，以防您需要同意才符合歐盟的[一般資料保護規定 (GDPR)](xref:security/gdpr)。</span><span class="sxs-lookup"><span data-stu-id="8359b-334">This app doesn't track personal information, but the project template includes the consent feature in case you need it to comply with the European Union's [General Data Protection Regulation (GDPR)](xref:security/gdpr).</span></span>

  ![Home 或：：：非 loc (Index) ：：： page](razor-pages-start/_static/homeGDPR2.2_safari.png)

  <span data-ttu-id="8359b-336">下圖顯示同意追蹤之後的應用程式：</span><span class="sxs-lookup"><span data-stu-id="8359b-336">The following image shows the app after consent to tracking is provided:</span></span>
...
## <a name="examine-the-project-files"></a><span data-ttu-id="8359b-338">檢查專案檔</span><span class="sxs-lookup"><span data-stu-id="8359b-338">Examine the project files</span></span>

<span data-ttu-id="8359b-339">以下概要說明主要專案資料夾和檔案，您將在稍後的教學課程中使用這些資料夾和檔案。</span><span class="sxs-lookup"><span data-stu-id="8359b-339">Here's an overview of the main project folders and files that you'll work with in later tutorials.</span></span>
...
<span data-ttu-id="8359b-352">包含靜態檔案，例如 HTML 檔案、JavaScript 檔案和 CSS 檔案。</span><span class="sxs-lookup"><span data-stu-id="8359b-352">Contains static files, like HTML files, JavaScript files, and CSS files.</span></span> <span data-ttu-id="8359b-353">如需詳細資訊，請參閱<xref:fundamentals/static-files>。</span><span class="sxs-lookup"><span data-stu-id="8359b-353">For more information, see <xref:fundamentals/static-files>.</span></span>

### <a name="appsettingsjson"></a><span data-ttu-id="8359b-354">appSettings.json</span><span class="sxs-lookup"><span data-stu-id="8359b-354">appSettings.json</span></span>

<span data-ttu-id="8359b-355">包含設定資料，例如連接字串。</span><span class="sxs-lookup"><span data-stu-id="8359b-355">Contains configuration data, like connection strings.</span></span> <span data-ttu-id="8359b-356">如需詳細資訊，請參閱<xref:fundamentals/configuration/index>。</span><span class="sxs-lookup"><span data-stu-id="8359b-356">For more information, see <xref:fundamentals/configuration/index>.</span></span>

### <a name="programcs"></a><span data-ttu-id="8359b-357">Program.cs</span><span class="sxs-lookup"><span data-stu-id="8359b-357">Program.cs</span></span>

<span data-ttu-id="8359b-358">包含程式的進入點。</span><span class="sxs-lookup"><span data-stu-id="8359b-358">Contains the entry point for the program.</span></span> <span data-ttu-id="8359b-359">如需詳細資訊，請參閱<xref:fundamentals/host/generic-host>。</span><span class="sxs-lookup"><span data-stu-id="8359b-359">For more information, see <xref:fundamentals/host/generic-host>.</span></span>
...
* [<span data-ttu-id="8359b-364">本教學課程的 YouTube 版本</span><span class="sxs-lookup"><span data-stu-id="8359b-364">YouTube version of this tutorial</span></span>](https://www.youtube.com/watch?v=F0SP7Ry4flQ&feature=youtu.be)

## <a name="next-steps"></a><span data-ttu-id="8359b-365">後續步驟</span><span class="sxs-lookup"><span data-stu-id="8359b-365">Next steps</span></span>

> [!div class="step-by-step"]
> [<span data-ttu-id="8359b-366">下一步：新增模型</span><span class="sxs-lookup"><span data-stu-id="8359b-366">Next: Add a model</span></span>](xref:tutorials/razor-pages/model)
