...
description: '頁面上教學課程系列的第6部分 :::no-loc(Razor)::: 。'
ms.author: riande
ms.date: 12/05/2019
no-loc:
- ':::no-loc(Index):::'
...
---
# <a name="part-6-add-search-to-aspnet-core-no-locrazor-pages"></a><span data-ttu-id="bc562-103">第6部分：將搜尋新增至 ASP.NET Core :::no-loc(Razor)::: 頁面</span><span class="sxs-lookup"><span data-stu-id="bc562-103">Part 6, add search to ASP.NET Core :::no-loc(Razor)::: Pages</span></span>
...
<span data-ttu-id="bc562-105">[檢視或下載範例程式碼](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie50) ([如何下載](xref:index#how-to-download-a-sample))。</span><span class="sxs-lookup"><span data-stu-id="bc562-105">[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie50) ([how to download](xref:index#how-to-download-a-sample)).</span></span>

::: moniker-end

::: moniker range="< aspnetcore-5.0 >= aspnetcore-3.0"

<span data-ttu-id="bc562-106">[檢視或下載範例程式碼](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie30) ([如何下載](xref:index#how-to-download-a-sample))。</span><span class="sxs-lookup"><span data-stu-id="bc562-106">[View or download sample code](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/tutorials/razor-pages/razor-pages-start/sample/:::no-loc(Razor):::PagesMovie30) ([how to download](xref:index#how-to-download-a-sample)).</span></span>
...
<span data-ttu-id="bc562-108">將下列反白顯示的 using 語句和屬性新增至 *Pages/電影/ :::no-loc(Index)::: . cshtml.cs* ：</span><span class="sxs-lookup"><span data-stu-id="bc562-108">Add the following highlighted using statement and properties to *Pages/Movies/:::no-loc(Index):::.cshtml.cs* :</span></span>
...
<span data-ttu-id="bc562-120">:::no-loc(Index):::以下列程式碼更新頁面的 `OnGetAsync` 方法：</span><span class="sxs-lookup"><span data-stu-id="bc562-120">Update the :::no-loc(Index)::: page's `OnGetAsync` method with the following code:</span></span>
...
<span data-ttu-id="bc562-138">如果將下列路由範本新增至 :::no-loc(Index)::: 頁面，則可以將搜尋字串作為 URL 區段傳遞。</span><span class="sxs-lookup"><span data-stu-id="bc562-138">If the following route template is added to the :::no-loc(Index)::: page, the search string can be passed as a URL segment.</span></span> <span data-ttu-id="bc562-139">例如 `https://localhost:5001/Movies/Ghost`。</span><span class="sxs-lookup"><span data-stu-id="bc562-139">For example, `https://localhost:5001/Movies/Ghost`.</span></span>
...
<span data-ttu-id="bc562-148">開啟 _Pages/Movies/] 檔案 :::no-loc(Index)::: ，並新增在下列程式碼中反白顯示的標記：</span><span class="sxs-lookup"><span data-stu-id="bc562-148">Open the _Pages/Movies/:::no-loc(Index):::.cshtml\* file, and add the markup highlighted in the following code:</span></span>
...
<span data-ttu-id="bc562-156">:::no-loc(Index):::以下列程式碼更新頁面的 `OnGetAsync` 方法：</span><span class="sxs-lookup"><span data-stu-id="bc562-156">Update the :::no-loc(Index)::: page's `OnGetAsync` method with the following code:</span></span>
...
### <a name="add-search-by-genre-to-the-no-locrazor-page"></a><span data-ttu-id="bc562-159">將依內容類型搜尋新增至 :::no-loc(Razor)::: 頁面</span><span class="sxs-lookup"><span data-stu-id="bc562-159">Add search by genre to the :::no-loc(Razor)::: Page</span></span>

1. <span data-ttu-id="bc562-160">將 *:::no-loc(Index)::: cshtml* [ `<form>` element] (更新 https://developer.mozilla.org/docs/Web/HTML/Element/form) 為在下列標記中反白顯示：</span><span class="sxs-lookup"><span data-stu-id="bc562-160">Update the *:::no-loc(Index):::.cshtml* [`<form>` element] (https://developer.mozilla.org/docs/Web/HTML/Element/form) as highlighted in the following markup:</span></span>
...
<span data-ttu-id="bc562-166">將下列反白顯示的屬性新增至 *Pages/電影/ :::no-loc(Index)::: . cshtml.cs* ：</span><span class="sxs-lookup"><span data-stu-id="bc562-166">Add the following highlighted properties to *Pages/Movies/:::no-loc(Index):::.cshtml.cs* :</span></span>
...
<span data-ttu-id="bc562-177">:::no-loc(Index):::以下列程式碼更新頁面的 `OnGetAsync` 方法：</span><span class="sxs-lookup"><span data-stu-id="bc562-177">Update the :::no-loc(Index)::: page's `OnGetAsync` method with the following code:</span></span>
...
<span data-ttu-id="bc562-195">如果將下列路由範本新增至 :::no-loc(Index)::: 頁面，則可以將搜尋字串作為 URL 區段傳遞。</span><span class="sxs-lookup"><span data-stu-id="bc562-195">If the following route template is added to the :::no-loc(Index)::: page, the search string can be passed as a URL segment.</span></span> <span data-ttu-id="bc562-196">例如 `https://localhost:5001/Movies/Ghost`。</span><span class="sxs-lookup"><span data-stu-id="bc562-196">For example, `https://localhost:5001/Movies/Ghost`.</span></span>
...
<span data-ttu-id="bc562-205">開啟 _Pages/Movies/] 檔案 :::no-loc(Index)::: ，並新增 `<form>` 在下列程式碼中反白顯示的標記：</span><span class="sxs-lookup"><span data-stu-id="bc562-205">Open the _Pages/Movies/:::no-loc(Index):::.cshtml\* file, and add the `<form>` markup highlighted in the following code:</span></span>
...
### <a name="add-search-by-genre-to-the-no-locrazor-page"></a><span data-ttu-id="bc562-216">將依內容類型搜尋新增至 :::no-loc(Razor)::: 頁面</span><span class="sxs-lookup"><span data-stu-id="bc562-216">Add search by genre to the :::no-loc(Razor)::: Page</span></span>

<span data-ttu-id="bc562-217">將 *:::no-loc(Index)::: cshtml* [ `<form>` element] (更新 https://developer.mozilla.org/docs/Web/HTML/Element/form) 為在下列標記中反白顯示：</span><span class="sxs-lookup"><span data-stu-id="bc562-217">Update the *:::no-loc(Index):::.cshtml* [`<form>` element] (https://developer.mozilla.org/docs/Web/HTML/Element/form) as highlighted in the following markup:</span></span>
