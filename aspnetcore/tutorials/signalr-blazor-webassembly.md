...
---
# <a name="use-aspnet-core-no-locsignalr-with-no-locblazor-webassembly"></a><span data-ttu-id="8ab34-103">搭配使用 SignalR ASP.NET Core Blazor WebAssembly</span><span class="sxs-lookup"><span data-stu-id="8ab34-103">Use ASP.NET Core SignalR with Blazor WebAssembly</span></span>
...
<span data-ttu-id="8ab34-105">本教學課程會教您使用與建立即時應用程式的基本概念 SignalR Blazor WebAssembly 。</span><span class="sxs-lookup"><span data-stu-id="8ab34-105">This tutorial teaches the basics of building a real-time app using SignalR with Blazor WebAssembly.</span></span> <span data-ttu-id="8ab34-106">您會了解如何：</span><span class="sxs-lookup"><span data-stu-id="8ab34-106">You learn how to:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="8ab34-107">建立 Blazor WebAssembly 託管應用程式專案</span><span class="sxs-lookup"><span data-stu-id="8ab34-107">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="8ab34-108">新增 SignalR 用戶端程式庫</span><span class="sxs-lookup"><span data-stu-id="8ab34-108">Add the SignalR client library</span></span>
> * <span data-ttu-id="8ab34-109">新增 SignalR 中樞</span><span class="sxs-lookup"><span data-stu-id="8ab34-109">Add a SignalR hub</span></span>
> * <span data-ttu-id="8ab34-110">新增 SignalR 中樞的服務和端點 SignalR</span><span class="sxs-lookup"><span data-stu-id="8ab34-110">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="8ab34-111">新增 Razor 聊天的元件程式碼</span><span class="sxs-lookup"><span data-stu-id="8ab34-111">Add Razor component code for chat</span></span>
...
## <a name="create-a-hosted-no-locblazor-webassembly-app-project"></a><span data-ttu-id="8ab34-127">建立託管 Blazor WebAssembly 應用程式專案</span><span class="sxs-lookup"><span data-stu-id="8ab34-127">Create a hosted Blazor WebAssembly app project</span></span>
...
1. <span data-ttu-id="8ab34-133">選取 **Blazor 應用程式** ，然後選取 **[下一步]** 。</span><span class="sxs-lookup"><span data-stu-id="8ab34-133">Select **Blazor App** and select **Next**.</span></span>

1. <span data-ttu-id="8ab34-134">輸入 `BlazorSignalRApp` [ **專案名稱** ] 欄位。</span><span class="sxs-lookup"><span data-stu-id="8ab34-134">Type `BlazorSignalRApp` in the **Project name** field.</span></span> <span data-ttu-id="8ab34-135">確認 **位置** 專案是正確的，或提供專案的位置。</span><span class="sxs-lookup"><span data-stu-id="8ab34-135">Confirm the **Location** entry is correct or provide a location for the project.</span></span> <span data-ttu-id="8ab34-136">選取 [建立]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-136">Select **Create**.</span></span>

1. <span data-ttu-id="8ab34-137">選擇 **Blazor WebAssembly 應用程式** 範本。</span><span class="sxs-lookup"><span data-stu-id="8ab34-137">Choose the **Blazor WebAssembly App** template.</span></span>
...
1. <span data-ttu-id="8ab34-149">選擇 **Blazor WebAssembly 應用程式** 範本。</span><span class="sxs-lookup"><span data-stu-id="8ab34-149">Choose the **Blazor WebAssembly App** template.</span></span> <span data-ttu-id="8ab34-150">選取 [下一步]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-150">Select **Next**.</span></span>
...
1. <span data-ttu-id="8ab34-154">在 [ **專案名稱** ] 欄位中，為應用程式命名 `BlazorSignalRApp` 。</span><span class="sxs-lookup"><span data-stu-id="8ab34-154">In the **Project Name** field, name the app `BlazorSignalRApp`.</span></span> <span data-ttu-id="8ab34-155">選取 [建立]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-155">Select **Create**.</span></span>
...
## <a name="add-the-no-locsignalr-client-library"></a><span data-ttu-id="8ab34-161">新增 SignalR 用戶端程式庫</span><span class="sxs-lookup"><span data-stu-id="8ab34-161">Add the SignalR client library</span></span>
...
1. <span data-ttu-id="8ab34-163">在 **方案總管** 中，以滑鼠右鍵按一下 `BlazorSignalRApp.Client` 專案，然後選取 [ **管理 NuGet 套件** ]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-163">In **Solution Explorer** , right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="8ab34-165">選取 **[流覽]** 之後， `Microsoft.AspNetCore.SignalR.Client` 在 [搜尋] 方塊中輸入。</span><span class="sxs-lookup"><span data-stu-id="8ab34-165">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="8ab34-166">在搜尋結果中選取封裝， [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) 然後選取 [ **安裝** ]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-166">In the search results, select the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Install**.</span></span>
...
1. <span data-ttu-id="8ab34-172">在 [ **方案** ] 提要欄位中，以滑鼠右鍵按一下 `BlazorSignalRApp.Client` 專案，然後選取 [ **管理 NuGet 套件** ]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-172">In the **Solution** sidebar, right-click the `BlazorSignalRApp.Client` project and select **Manage NuGet Packages**.</span></span>
...
1. <span data-ttu-id="8ab34-174">選取 **[流覽]** 之後， `Microsoft.AspNetCore.SignalR.Client` 在 [搜尋] 方塊中輸入。</span><span class="sxs-lookup"><span data-stu-id="8ab34-174">With **Browse** selected, type `Microsoft.AspNetCore.SignalR.Client` in the search box.</span></span>

1. <span data-ttu-id="8ab34-175">在搜尋結果中，選取套件旁的核取方塊 [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) ，然後選取 [ **新增套件** ]。</span><span class="sxs-lookup"><span data-stu-id="8ab34-175">In the search results, select the check box next to the [`Microsoft.AspNetCore.SignalR.Client`](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) package and select **Add Package**.</span></span>
...
## <a name="add-a-no-locsignalr-hub"></a><span data-ttu-id="8ab34-179">新增 SignalR 中樞</span><span class="sxs-lookup"><span data-stu-id="8ab34-179">Add a SignalR hub</span></span>

<span data-ttu-id="8ab34-180">在 `BlazorSignalRApp.Server` 專案中，建立 `Hubs` (複數) 資料夾，並 () 新增下列 `ChatHub` 類別 `Hubs/ChatHub.cs` ：</span><span class="sxs-lookup"><span data-stu-id="8ab34-180">In the `BlazorSignalRApp.Server` project, create a `Hubs` (plural) folder and add the following `ChatHub` class (`Hubs/ChatHub.cs`):</span></span>
...
## <a name="add-services-and-an-endpoint-for-the-no-locsignalr-hub"></a><span data-ttu-id="8ab34-181">新增中樞的服務和端點 SignalR</span><span class="sxs-lookup"><span data-stu-id="8ab34-181">Add services and an endpoint for the SignalR hub</span></span>

1. <span data-ttu-id="8ab34-182">在 `BlazorSignalRApp.Server` 專案中，開啟 `Startup.cs` 檔案。</span><span class="sxs-lookup"><span data-stu-id="8ab34-182">In the `BlazorSignalRApp.Server` project, open the `Startup.cs` file.</span></span>
...
1. <span data-ttu-id="8ab34-184">新增 SignalR 和回應壓縮中介軟體服務至 `Startup.ConfigureServices` ：</span><span class="sxs-lookup"><span data-stu-id="8ab34-184">Add SignalR and Response Compression Middleware services to `Startup.ConfigureServices`:</span></span>
...
## <a name="add-no-locrazor-component-code-for-chat"></a><span data-ttu-id="8ab34-188">新增 Razor 聊天的元件程式碼</span><span class="sxs-lookup"><span data-stu-id="8ab34-188">Add Razor component code for chat</span></span>

1. <span data-ttu-id="8ab34-189">在 `BlazorSignalRApp.Client` 專案中，開啟 `Pages/Index.razor` 檔案。</span><span class="sxs-lookup"><span data-stu-id="8ab34-189">In the `BlazorSignalRApp.Client` project, open the `Pages/Index.razor` file.</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="8ab34-226">建立 Blazor WebAssembly 託管應用程式專案</span><span class="sxs-lookup"><span data-stu-id="8ab34-226">Create a Blazor WebAssembly Hosted app project</span></span>
> * <span data-ttu-id="8ab34-227">新增 SignalR 用戶端程式庫</span><span class="sxs-lookup"><span data-stu-id="8ab34-227">Add the SignalR client library</span></span>
> * <span data-ttu-id="8ab34-228">新增 SignalR 中樞</span><span class="sxs-lookup"><span data-stu-id="8ab34-228">Add a SignalR hub</span></span>
> * <span data-ttu-id="8ab34-229">新增 SignalR 中樞的服務和端點 SignalR</span><span class="sxs-lookup"><span data-stu-id="8ab34-229">Add SignalR services and an endpoint for the SignalR hub</span></span>
> * <span data-ttu-id="8ab34-230">新增 Razor 聊天的元件程式碼</span><span class="sxs-lookup"><span data-stu-id="8ab34-230">Add Razor component code for chat</span></span>

<span data-ttu-id="8ab34-231">若要深入瞭解如何建立 Blazor 應用程式，請參閱 Blazor 檔：</span><span class="sxs-lookup"><span data-stu-id="8ab34-231">To learn more about building Blazor apps, see the Blazor documentation:</span></span>

> [!div class="nextstepaction"]
> <span data-ttu-id="8ab34-232"><xref:blazor/index>
> [使用 Identity 伺服器、websocket 和 Server-Sent 事件的持有人權杖驗證](xref:signalr/authn-and-authz#bearer-token-authentication)</span><span class="sxs-lookup"><span data-stu-id="8ab34-232"><xref:blazor/index>
...
* [<span data-ttu-id="8ab34-234">SignalR 驗證的跨原始來源協商</span><span class="sxs-lookup"><span data-stu-id="8ab34-234">SignalR cross-origin negotiation for authentication</span></span>](xref:blazor/fundamentals/additional-scenarios#signalr-cross-origin-negotiation-for-authentication)
